...
const HREmpCreatingForm = ({ open, handleClose, onSave }) => {
    ...
    useEffect(() => {
        const fetchDesignations = async () => {
            try {
                const response = await axios.get(
                    `${APIbackendURl.basePointUrl}applicationservice/designationMaster/getAllDesignation`
                );
                const designations = response.data.designationMasterModel;
                            ...
                            <Grid container spacing={1}>
                                    ...
                                    >
                                        {designationList && designationList.length > 0 ? (
                                            designationList.map((designation) => (
                                                <MenuItem value={designation.designationId} key={designation.designationId}>
                                ...
                                <Grid item xs={12} sm={4} md={4}>
                                    <TextField
                                        ...
                                        variant="outlined"
                                        select
                                        value={formik.values.projConLogin}
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}
                                        fullWidth
                                        margin="normal"
                                        error={formik.touched.projConLogin && formik.errors.projConLogin}
                                        helperText={formik.touched.projConLogin && formik.errors.projConLogin}
                                    >
                                ...
                                <Grid item xs={12} sm={4} md={4}>
                                    <TextField
                                        ...
                                        variant="outlined"
                                        select
                                        value={formik.values.salesConLogin}
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}
                                        fullWidth
                                        margin="normal"
                                        error={formik.touched.salesConLogin && formik.errors.salesConLogin}
                                        helperText={formik.touched.salesConLogin && formik.errors.salesConLogin}
                                    >
                                        <MenuItem value={true}>Yes</MenuItem>
                                        <MenuItem value={false}>No</MenuItem>
                                    </TextField>
...
// const designationList = ["Software Testing", "", ""];

const departmentList = ["IT", "Sales"];
