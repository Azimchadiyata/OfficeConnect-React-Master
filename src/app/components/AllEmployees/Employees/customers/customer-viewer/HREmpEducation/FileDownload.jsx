...
const FileDownload = ({ datamap, downloadlink, folderName, Id }) => {
    ...
    const handleDeleteFile = async (fileName, fileNameType, folderName, quldocId) => {
        try {
            const response = await axios.post(
                `${APIbackendURl.basePointUrl}employeeservice/empQualification/deleteQualificationDocs/${fileName}&${fileNameType}&${folderName}&${quldocId}`
            );
